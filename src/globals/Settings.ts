...
export const Settings: GlobalConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'textarea',
          label: 'Дисклеймер под таблицами тарифов',
          required: true,
          defaultValue:
            'Условия тарифов приведены по данным фирмы «1С» и могут меняться. Актуальный состав приложений и стоимость уточняйте в заявке.',
          admin: {
            description:
    ...
    // Счётчики компании. Одна плашка на главную и на «О компании» — раньше
    // у каждой страницы были свои, и цифры в них уже разошлись («20+» и
    // «2014» против «2014 — год основания»). Живут здесь по тому же
    // правилу, что tariffDisclaimer: два потребителя — общее место, а
    // Settings гасит кеш всего сайта, то есть обеих страниц сразу
    {
      name: 'counters',
      type: 'array',
      label: 'Счётчики компании',
          ...
          fields: [
            {
              ...
              label: 'Число',
              required: true,
              admin: { description: 'Например: 2006, 300+, 1200+' },
            },
