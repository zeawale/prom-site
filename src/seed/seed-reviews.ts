...
const REVIEWS = [
  ...
  {
    // Четвёртый отзыв закрывает персону «кадровик» из раздела 4 промта:
    // остальные три — про учёт, облако и перенос базы, кадрового сценария
    // среди них не было
    author: 'Марина Соколова',
    role: 'руководитель отдела кадров, сеть кофеен «Заря»',
    text: 'Точек шесть, кадровые документы возили между ними бумагой. Подключили 1С:Кабинет сотрудника — заявления и расчётные листки сотрудники видят с телефона, подписывать ничего не нужно везти.',
    order: 4,
  },
]
